                        ...
                        <div data-v-e95a8a8c="" class="d" style="width:800px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-e95a8a8c="" class="d-inner">
                                    ...
                                    <div data-v-e95a8a8c="" class="col-33">
                                        <table data-v-e95a8a8c="" class="summary-table">
                                            ...
                                            <tr data-v-e95a8a8c="">
                                                ...
                                                <td data-v-e95a8a8c="" class="text-right">{{\App\Utility::billNumberFormat($settings,$bill->bill_id)}}</td>
                                            </tr>
                                            <tr data-v-e95a8a8c="">
                                                <td data-v-e95a8a8c="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-e95a8a8c="" class="text-right">{{\App\Utility::dateFormat($settings,$bill->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-e95a8a8c="">
                                                <td data-v-e95a8a8c="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                                <td data-v-e95a8a8c="" class="text-right">{{\App\Utility::dateFormat($settings,$bill->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-e95a8a8c="" class="d-table">
                                    <div data-v-e95a8a8c="" class="d-table">
                                        <div data-v-e95a8a8c="" class="tu d-table-tr" style="color: {{$color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
