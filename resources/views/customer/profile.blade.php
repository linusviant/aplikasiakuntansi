                        ...
                        <div class="profile-sidebar">
                            <div class="portlet light profile-sidebar-portlet ">
                                ...
                                <div class="profile-usertitle">
                                    ...
                                    <div class="profile-usertitle-job font-style"> {{'Customer'}}</div>
                                </div>
                                    ...
                                    <div class="tab-content" id="myTabContent2">
                                        <div class="tab-pane fade show active" id="personal_info" role="tabpanel" aria-labelledby="home-tab3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-right">
                                                    <a href="{{ route('customer.dashboard') }}" class="btn btn-secondary">{{__('Cancel')}}</a>
                                        ...
                                        <div class="tab-pane fade" id="billing" role="tabpanel" aria-labelledby="profile-tab3">
                                            <div class="company-setting-wrap">
                                                {{Form::model($userDetail,array('route' => array('customer.update.billing.info'), 'method' => 'put'))}}
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                        ...
                                        <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="profile-tab3">
                                            <div class="company-setting-wrap">
                                                {{Form::model($userDetail,array('route' => array('customer.update.shipping.info'), 'method' => 'put'))}}
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
