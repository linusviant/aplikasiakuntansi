                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('PROPOSAL')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{\App\Utility::proposalNumberFormat($settings,$proposal->proposal_id)}}</h3>
                                        <p data-v-7d9d14b5="">{{\App\Utility::dateFormat($settings,$proposal->issue_date)}}</p>
                                    </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                ...
                                                <td data-v-7d9d14b5="" class="text-right">{{\App\Utility::dateFormat($settings,$proposal->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
